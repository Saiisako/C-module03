...
/*   Updated: 2025/06/13 19:46:36 by skock            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(const std::string &name, int hp, int ep, int ad) : name(name), hit_points(hp), energy_points(ep), attack_damage(ad)
{
	std::cout << "Constructing claptrap" << std::endl;
}
